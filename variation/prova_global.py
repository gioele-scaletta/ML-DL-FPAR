    ...
    def __init__(
        ...
        for t, c, n, s in inverted_residual_setting:
            ...
            for i in range(n):
                ...
                features.append(block(input_channel, output_channel, stride, expand_ratio=t, last=False, norm_layer=norm_layer))
                input_channel = output_channel
            features.append(block(input_channel, output_channel, stride=1, expand_ratio=t, last=False, norm_layer=norm_layer))
            input_channel = output_channel
